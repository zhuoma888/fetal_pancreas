...
GO_df[[1]] <- GO_df[[1]][which(GO_df[[1]]$ID %in% c("GO:0007219","GO:0032970","GO:0034329","GO:0051960","GO:0016055","GO:0043410")),]
GO_df[[2]] <- GO_df[[2]][which(GO_df[[2]]$ID %in% c("GO:0045787")),]
GO_df[[3]] <- GO_df[[3]][which(GO_df[[3]]$ID %in% c("GO:0071559","GO:0030509")),]
GO_df[[4]] <- GO_df[[4]][which(GO_df[[4]]$ID %in% c("GO:0055076","GO:0052547","GO:0097193","GO:0007586")),]
...
GO_df$pvalue_log <- -log10(GO_df$pvalue)
GO_df <- GO_df %>% arrange(-cluster,pvalue_log)

ggbarplot(GO_df, y = "pvalue_log", x = "Description",
          color = "grey", fill = "grey", rotate = T,
          xlab = "Cluster",
          ylab = "-log10(p-value)")
